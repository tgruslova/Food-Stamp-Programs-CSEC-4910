...
# Data:
    # ACS 1-Year Estimates - Puerto Rico Public Use Microdata Sample 2023
    # Via US Census API Call

url = "https://api.census.gov/data/2023/acs/acs1/pumspr"
...
#00100: Aguadilla, Aguada, Moca, & Rincon
oo100_FS = (71 + 51 + 56 + 13) / (53592 + 37509 + 37322 + 15420) * 100

#00200: Mayaguez, Anasco & Hormigueros
oo200_FS = (88+32+12) / (69741+24796+15327) * 100

#00300: Cabo Rojo, San German & Lajas
oo300_FS = (41+24+21) / (46646+30970+22862) * 100

#00400: Yauco, Sabana Grande, Penuelas, Guayanilla & Guanica
oo400_FS = (38+17+32+47+16) / (32387+22189+19566+16801+12408) * 100

#00500: Ponce
oo500_FS = (137) / (130153) * 100

#00600: Juana Diaz, Coamo, Villalba, & Santa Isabel
oo600_FS = (48+39+30+24) / (45895+33644+21268+19675) * 100

#00700: Guayama, Salinas, Patillas, Arroyo, & Maunabo
oo700_FS = (31+30+20+17+15) / (34753+24706+15335+15062+10270) * 100

#00800: Humacao, Fajardo, Naguabo, Yabucoa, Ceiba, Culebra & Vieques
oo800_FS = (48+33+20+27+10+4+14) / (49659+31149+22826+28876+10840+1762+7988) * 100

#00900: Rio Grande, Canovanas, Loiza, & Luquillo
oo900_FS = (32+37+24+15) / (45554+41488+22299+17383) * 100

#01000: Carolina
o1000_FS = (84) / (150777) * 100

#01101 & 01102: San Juan
o1100_FS = (256) / (332789) * 100

#01200: Guaynabo & Catano
o1200_FS = (47+27) / (88995+22099) * 100

#01300: Bayamon
o1300_FS = (143) / (180751) * 100

#01400: Toa Baja & Dorado
o1400_FS = (41+26) / (71838+35699) * 100

#01500: Toa Alta, Corozal & Naranjito
o1500_FS = (39+34+31) / (65918+34318+29265) * 100

#01600: Vega Baga, Vega Alta & Morovis
o1600_FS = (52+28+37) / (53506+34617+28182) * 100

#01700: Arecibo, Manati, Barceloneta, & Florida
o1700_FS = (70+35+24+16) / (85579+38631+22354+11418) * 100

#01800: Isabela, Hatillo, Camuy, & Quebradillas
o1800_FS = (41+54+31+25) / (42761+37927+32603+23251) * 100

#01900: San Sebastian, Utuado, Lares, Adjuntas, Ciales, Jayuya, Las Marias, Maricao, & Orocovis
o1900_FS = (71+32+52+42+20+29+11+6+36) / (38899+27236+27713+17887+16684+14424+8668+4521+21209) * 100

#02000: Cayey, Cidra, Barranquitas, Aguas Buenas, Aibonito, & Comerio
o2000_FS = (36+31+70+21+21+32) / (40513+39390+29006+23260+24586+18595) * 100

#02100: Caguas
o2100_FS = (99) / (124539) * 100

#02200: Trujillo Alto & Gurabo
o2200_FS = (29+20) / (66655+39959) * 100

#02300:San Lorenzo, Juncos & Las Piedras
o2300_FS = (30+36+36) / (37242+36668+34739) * 100
...
df['SIMBENEFIT'] = vect(df['HHSIZE'], df['avg_HINCP'], df['R65'], 2023, 'NAP')
df['SQ_SIMBENEFIT'] = np.square(df['SIMBENEFIT'])
df['SIMBENEFIT_SNAP'] = vect(df['HHSIZE'], df['avg_HINCP'], df['R65'], 2023, 'SNAP')
